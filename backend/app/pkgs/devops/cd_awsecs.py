...
class CDAWS:
    def triggerCD(self, image, serviceInfo, cdConfig):
        aws_service_name, aws_alb_name, aws_tg_name = (
            self.generate_names_with_timestamp(serviceInfo["service_id"])
        )
        print(
            "cdConfig : ",
            cdConfig,
        ...
        alb_arn, tg_arn, alb_dns_name, success = self.create_alb_and_target_group(
            cdConfig, serviceInfo, aws_alb_name, aws_tg_name
        )
        if not success:
        ...
        container_definition = {
            ...
            "image": "docker.io/jaysonwor/my-nginx:latest",
            "cpu": 1024,
            "memory": 2048,
            "essential": True,
            "portMappings": [
            ...
            "logConfiguration": {
                "logDriver": "awslogs",
                "options": {
                    "awslogs-group": "/ecs/devopsgpt",
                    "awslogs-region": serviceInfo["cd_region"],
        ...
        try:
            response = client.register_task_definition(
                ...
                taskRoleArn=serviceInfo["cd_execution_role_arn"],
            ...
            if aws_service_name in existing_services["serviceArns"]:
                ...
                client.create_service(
                    ...
                    networkConfiguration={
                        "awsvpcConfiguration": {
                            "subnets": [
                                serviceInfo["cd_subnet"],
                                serviceInfo["cd_subnet2"],
                            ],
        ...
        return (
            f"Visit URL：http://{alb_dns_name}:8086 （This environment is for experience only and will be deleted after 1 hour）",
            True,
        )
